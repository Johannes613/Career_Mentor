...
const AboutSection = () => {
  ...
  const features = [
    {
      icon: <Zap size={20} />,
      text: "Centralized AI tools for a streamlined workflow.",
    },
    {
      icon: <Target size={20} />,
      text: "Data-driven insights, not generic templates.",
    },
    {
      icon: <GraduationCap size={20} />,
      text: "A clear path from learning to landing a job.",
    },
  ];
  ...
  return (
    <Box
      id="about"
      sx={{ py: 10, bgcolor: "background.default", minHeight: "65vh" }}
    >
      <div className="container">
        ...
        <div className="row align-items-center g-4">
          ...
          <div className="col-12 col-md-6">
            ...
            >
              We understand the challenges students face. Disorganized
              resources, generic advice, and uncertainty about the future.
              CareerMentorAI was built to solve these problems and related
